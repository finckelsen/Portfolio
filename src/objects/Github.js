...
export function Github({contactOpen, setContactOpen}) {
  ...
  const handleClick = () => {
    if (!contactOpen){
      ...
      window.open('https://github.com/finckelsen/', '_blank');
  ...
  return (
    <group>
      <mesh
        position={[2.2, 1.8, 3.8]} // Lägger plattan framför kameran på väggen
